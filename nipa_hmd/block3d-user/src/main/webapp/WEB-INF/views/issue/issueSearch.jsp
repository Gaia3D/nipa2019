...
<div id="issueSearch">
    <form id="searchIssueForm" onsubmit="return false;">
    <ul class="section issue" id="issueSearchArea" style="height: 165px;">
        <!-- 이슈검색 -->
        <li>
        ...
        <li>
            <button type="button" id="issueSearchButton" class="textBtn full">이슈 검색</button>
        </li>
    </ul>
    </form>
